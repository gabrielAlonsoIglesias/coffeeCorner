...
###### Steps
1. Clone repository *https://github.com/gabrielAlonsoIglesias/coffeeCorner* into location *B*
2. Open IDE and import Project (General > Existing Projects into Workspace) from location *B*
